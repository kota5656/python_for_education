...
要は情報を調べたいと思った時に、ちゃんと公式サイトや著名な出版の参考書や
論文等の一次ソースから調べてますかって話です。

無名の二次ソースを鵜呑みにしたり、校閲の曖昧な読み物を漁ったり、
Youtube広告での宣伝に騙されたり、ゆっくり解説や中●敦彦やひろ○きみたいな
浅く狭い情報で調べ事を解決してませんか？って話です。

何でその方法で本格的な知識を得ようとしたらまずいのかというと、要は一言で
厳密性が無いからです。本当はもっと細かく説明されてるはずの情報が、一般人
用に噛み砕かれると、その分の情報格差で誤解が生じる恐れがあります。

それを避けるためにも、情報を得たいなら専門家らしい手段で適切に情報を探索
しましょう。それが言いたいだけです。
